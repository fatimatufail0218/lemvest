...
export default function Chip({ icon, label, className = "" }: ChipProps) {
  return (
    <div
      className={`flex items-center justify-center gap-[8px] md:gap-1.5 rounded-[8px] border border-black/10 dark:border-white/10 bg-black/[0.04] dark:bg-white/[0.04] px-4 py-2.5 md:px-3 md:py-1.5 lg:px-3.5 lg:py-2 w-full sm:w-auto ${className}`}
    >
